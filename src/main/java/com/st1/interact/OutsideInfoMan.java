...
public class OutsideInfoMan extends BaseNpc {
    ...
    public String firstSightingMessage() {
        return
                        ...
                        + "I de rum kan du placere de ressourcer vi skal bruge for at omdanne reaktoren til en Small Modular Reactor. \n"
                        ...
                        + "Bevæg dig rundt omkring i verdenen, for at finde de ressourcer du skal bruge. \n"
