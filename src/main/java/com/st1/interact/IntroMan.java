...
public class IntroMan extends BaseNpc {
    ...
    public String firstSightingMessage() {
        return """
                ...
                Os her i Yurigistan har truffet en dristig, men hvad vi mener er en nødvendig beslutning for at efterleve Parisaftalens krav om at udfase kulkraft inden 2030.
                Vi er derfor i gang med at lukke flere af vores kulkraftværker, som står til at blive erstattet af atomkraftværker hurtigst muligt, for at sikre en blød overgang. Vi har brug for dig, som konsulent til at overvåge og råde os i ombygningen af vores kulkraftværker.
