...
public class IntroMan extends BaseNpc {
    ...
    public String firstSightingMessage() {
        return """
                Hej (name). Velkommen til Yurigistan,
                ...
                Vi er derfor i gang med at lukke flere af vores kulkraftværker som står til at blive erstattet af atomkraftværker hurtigst muligt for at sikre en blød overgang. Vi har hentet dig ind som konsulent for at overvåge og råde os i ombygningen af (et eller flere) kulkraftværker.
