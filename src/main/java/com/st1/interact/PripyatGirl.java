...
public class PripyatGirl extends BaseNpc {
    ...
    public String firstSightingMessage() {
        return "Velkommen til Pripyat! \nPripyat var engang en blomstrende by, hjemsted for arbejderne ved Tjernobyl-kernekraftværket. Før katastrofen i 1986 havde byen et pulserende samfund med mennesker, der arbejdede i forskellige sektorer som landbrug, undervisning og industri.  \n" +
                "Reaktor 1 ved Tjernobyl-atomkraftværket blev først taget i brug i 1977, mens den første kommercielle atomkraftreaktorer blev taget i brug fra 1954. Katastrofen, der ramte Tjernobyl i 1986 under en sikkerhedsprøve, ændrede vores opfattelse af denne kraftfulde, men komplekse energiform. \n" +
                ...
                "Ulykken fik meget opmærksomhed og havde en betydelig indvirkning på folks syn på atomkraft, hvor mange lande valgte at revurdere deres atomkraftspolitik som førte til udfasning eller bremset udviklingen af nye atomkraftværker, på trods af at denne ulykke, kunne have været stoppet, før den begyndte. \n";
    }
